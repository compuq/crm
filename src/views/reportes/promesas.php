<div class="card bg-dark border-secondary p-4 mb-4">
    ...
    <form method="GET" class="row g-3 mb-4 bg-dark p-3 rounded border border-secondary">
        <input type="hidden" name="action" value="reportes_promesas">
        <div class="col-md-2"><label class="text-secondary small">Desde</label><input type="date" name="fecha_inicio" class="form-control bg-dark text-white border-secondary" value="<?= $filters['fecha_inicio'] ?>"></div>
        <div class="col-md-2"><label class="text-secondary small">Hasta</label><input type="date" name="fecha_fin" class="form-control bg-dark text-white border-secondary" value="<?= $filters['fecha_fin'] ?>"></div>
        <div class="col-md-2">
            <label class="text-secondary small">Estado Promesa</label>
        ...
        <div class="col-md-4 d-flex align-items-end gap-2">
            ...
            <a href="?action=reportes_promesas" class="btn btn-outline-secondary">🔄</a>
        </div>
    </form>
